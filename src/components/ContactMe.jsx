...
const ContactMe = () => {
  return (
    <section id="ContactSection" className="bg-[#032825] text-white py-10 flex flex-col items-center text-center">
      <div className="flex gap-[130px] justify-center flex-wrap max-w-6xl w-full px-4">

        {/* Address */}
        <div className="flex flex-col items-center max-w-[200px]">
          <FontAwesomeIcon icon={faHome} className="text-3xl text-[#98760B] mb-2" />
        ...
        {/* Phone */}
        <div className="flex flex-col items-center max-w-[200px]">
          <FontAwesomeIcon icon={faPhone} className="text-3xl text-[#98760B] mb-2" />
        ...
        {/* Email */}
        <div className="flex flex-col items-center max-w-[200px]">
          <FontAwesomeIcon icon={faEnvelope} className="text-3xl text-[#98760B] mb-2" />
